...
Shaomei Wu is a person who stutters and the founder and CEO of [AImpower.org](https://aimpower.org), a tech nonprofit that researches and co-creates empowering technologies *for*, *with*, and *by* marginalized communities. As a technologist, researcher, and disability advocate, she brings together lived experience, technical expertise, and community knowledge to advance more accessible, equitable, and empowering AI systems, with a particular focus on disability-affirming speech and communication technologies.

Previously, Shaomei was a staff research scientist and Tech Lead at Facebook and Instagram, where she led research and product initiatives serving underserved communities, including [automatic alt-text](https://tech.fb.com/artificial-intelligence/2018/06/using-artificial-intelligence-to-help-blind-people-see-facebook/), an AI-powered service that describes billions of images on Facebook and Instagram to screen reader users each day. Shaomei holds a Ph.D in Information Science from Cornell University, where she studied the spread of information and behaviors in large social networks. Her current research interests lie in AI ethics, accessibility, human computer interaction (HCI), and speech science & technology. Shaomei frequently publishes at leading academic conferences including CHI, CSCW, FAccT, ASSETS, and InterSpeech, and serves on program committees for NeurIPS, CHI, CSCW, ASSETS, ICWSM, WWW, and AIES. As a stuttering advocate, Shaomei regularly organizes and speaks at technical and community conventions on disfluency-friendly speech and communication technologies, and advises stuttering community organizations on technical issues and strategies.
